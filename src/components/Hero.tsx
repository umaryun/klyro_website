    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full pt-24 pb-16">
        <div className="flex flex-col lg:flex-row items-center lg:items-start">
          {/* Left Content */}
          <div className="lg:pl-13 flex-1 lg:pt-8">
            {/* Heading */}
            ...
            {/* Subtext */}
            <p className="mt-7 max-w-[460px] text-[clamp(0.95rem,1.5vw,1.1rem)] leading-[1.75] text-klyro-white font-light animate-fade-in-up-delay-2">
            ...
            {/* CTA Buttons */}
            <div className="mt-10 flex flex-wrap items-center gap-5 animate-fade-in-up-delay-3">
              <a
                href="#contact"
                id="hero-get-started"
